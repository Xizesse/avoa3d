...
def generate_launch_description():
    ...
    # 3. Obstacle Publisher (from rvo2_ros2) 
    # Publishes /obstacles_array from /model/obstacle_*/odometry
    # The rvo2_node needs the custom message format provided by this node
