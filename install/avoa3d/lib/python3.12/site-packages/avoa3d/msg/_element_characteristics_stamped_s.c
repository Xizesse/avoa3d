...
bool avoa3d__msg__element_characteristics_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avoa3d.msg._element_characteristics_stamped.ElementCharacteristicsStamped", full_classname_dest, 73) == 0);
  }
  avoa3d__msg__ElementCharacteristicsStamped * ros_message = _ros_message;
  {  // header
...
PyObject * avoa3d__msg__element_characteristics_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("avoa3d.msg._element_characteristics_stamped");
