...
#include "avoa/msg/detail/element_characteristics_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = avoa::msg::ElementCharacteristicsStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const avoa::msg::ElementCharacteristicsStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<avoa::msg::ElementCharacteristicsStamped *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_avoa
const rosidl_message_type_support_t *
get_message_type_support_handle<avoa::msg::ElementCharacteristicsStamped>()
{
  return &avoa::msg::typesupport_fastrtps_cpp::_ElementCharacteristicsStamped__handle;
}
