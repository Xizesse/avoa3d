...
#include "avoa3d/msg/detail/element_characteristics_stamped__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_avoa3d
...
using _ElementCharacteristicsStamped__ros_msg_type = avoa3d__msg__ElementCharacteristicsStamped;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = avoa3d__msg__ElementCharacteristicsStamped;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const avoa3d__msg__ElementCharacteristicsStamped * ros_message = static_cast<const avoa3d__msg__ElementCharacteristicsStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_avoa3d__msg__ElementCharacteristicsStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  avoa3d__msg__ElementCharacteristicsStamped * ros_message = static_cast<avoa3d__msg__ElementCharacteristicsStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_avoa3d__msg__ElementCharacteristicsStamped(cdr, ros_message);
}

static uint32_t _ElementCharacteristicsStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_avoa3d__msg__ElementCharacteristicsStamped(
...
static size_t _ElementCharacteristicsStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_avoa3d__msg__ElementCharacteristicsStamped(
