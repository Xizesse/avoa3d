...
static const _ElementCharacteristicsStamped_type_support_symbol_names_t _ElementCharacteristicsStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avoa3d, msg, ElementCharacteristicsStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, avoa3d, msg, ElementCharacteristicsStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, avoa3d, msg, ElementCharacteristicsStamped)() {
  return &::avoa3d::msg::rosidl_typesupport_c::ElementCharacteristicsStamped_message_type_support_handle;
}
