...
avoa3d__msg__ElementCharacteristicsStamped__init(avoa3d__msg__ElementCharacteristicsStamped * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    avoa3d__msg__ElementCharacteristicsStamped__fini(msg);
    return false;
  }
  // id
  // type
...
avoa3d__msg__ElementCharacteristicsStamped__create(void)
{
  ...
  avoa3d__msg__ElementCharacteristicsStamped * msg = (avoa3d__msg__ElementCharacteristicsStamped *)allocator.allocate(sizeof(avoa3d__msg__ElementCharacteristicsStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(avoa3d__msg__ElementCharacteristicsStamped));
  bool success = avoa3d__msg__ElementCharacteristicsStamped__init(msg);
  if (!success) {
...
avoa3d__msg__ElementCharacteristicsStamped__Sequence__init(avoa3d__msg__ElementCharacteristicsStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  avoa3d__msg__ElementCharacteristicsStamped * data = NULL;

  if (size) {
    data = (avoa3d__msg__ElementCharacteristicsStamped *)allocator.zero_allocate(size, sizeof(avoa3d__msg__ElementCharacteristicsStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = avoa3d__msg__ElementCharacteristicsStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        avoa3d__msg__ElementCharacteristicsStamped__fini(&data[i - 1]);
      }
...
avoa3d__msg__ElementCharacteristicsStamped__Sequence__fini(avoa3d__msg__ElementCharacteristicsStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      avoa3d__msg__ElementCharacteristicsStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  avoa3d__msg__ElementCharacteristicsStamped__Sequence * array = (avoa3d__msg__ElementCharacteristicsStamped__Sequence *)allocator.allocate(sizeof(avoa3d__msg__ElementCharacteristicsStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = avoa3d__msg__ElementCharacteristicsStamped__Sequence__init(array, size);
  if (!success) {
...
avoa3d__msg__ElementCharacteristicsStamped__Sequence__destroy(avoa3d__msg__ElementCharacteristicsStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    avoa3d__msg__ElementCharacteristicsStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
avoa3d__msg__ElementCharacteristicsStamped__Sequence__are_equal(const avoa3d__msg__ElementCharacteristicsStamped__Sequence * lhs, const avoa3d__msg__ElementCharacteristicsStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!avoa3d__msg__ElementCharacteristicsStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  avoa3d__msg__ElementCharacteristicsStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(avoa3d__msg__ElementCharacteristicsStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    avoa3d__msg__ElementCharacteristicsStamped * data =
      (avoa3d__msg__ElementCharacteristicsStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!avoa3d__msg__ElementCharacteristicsStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          avoa3d__msg__ElementCharacteristicsStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!avoa3d__msg__ElementCharacteristicsStamped__copy(
