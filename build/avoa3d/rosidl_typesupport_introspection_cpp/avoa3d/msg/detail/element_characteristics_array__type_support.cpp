...
{
  new (message_memory) avoa3d::msg::ElementCharacteristicsArray(_init);
}

void ElementCharacteristicsArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<avoa3d::msg::ElementCharacteristicsArray *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<avoa3d::msg::ElementCharacteristicsStamped> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<avoa3d::msg::ElementCharacteristicsStamped> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<avoa3d::msg::ElementCharacteristicsStamped> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const avoa3d::msg::ElementCharacteristicsStamped *>(
    get_const_function__ElementCharacteristicsArray__elements(untyped_member, index));
  auto & value = *reinterpret_cast<avoa3d::msg::ElementCharacteristicsStamped *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<avoa3d::msg::ElementCharacteristicsStamped *>(
    get_function__ElementCharacteristicsArray__elements(untyped_member, index));
  const auto & value = *reinterpret_cast<const avoa3d::msg::ElementCharacteristicsStamped *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ElementCharacteristicsArray_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<avoa3d::msg::ElementCharacteristicsStamped>(),  // members of sub message
    false,  // is key
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(avoa3d::msg::ElementCharacteristicsArray, elements),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ElementCharacteristicsArray_message_members = {
  ...
  1,  // number of fields
  sizeof(avoa3d::msg::ElementCharacteristicsArray),
...
{
  return &::avoa3d::msg::rosidl_typesupport_introspection_cpp::ElementCharacteristicsArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, avoa3d, msg, ElementCharacteristicsArray)() {
  return &::avoa3d::msg::rosidl_typesupport_introspection_cpp::ElementCharacteristicsArray_message_type_support_handle;
}
