...
static const _ElementCharacteristicsStamped_type_support_symbol_names_t _ElementCharacteristicsStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rvo2_ros2, msg, ElementCharacteristicsStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rvo2_ros2, msg, ElementCharacteristicsStamped)),
  }
};
...
{
  return &::rvo2_ros2::msg::rosidl_typesupport_cpp::ElementCharacteristicsStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rvo2_ros2, msg, ElementCharacteristicsStamped)() {
  return get_message_type_support_handle<rvo2_ros2::msg::ElementCharacteristicsStamped>();
}
