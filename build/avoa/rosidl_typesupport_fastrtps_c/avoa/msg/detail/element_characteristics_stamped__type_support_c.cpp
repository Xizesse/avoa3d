...
#include "avoa/msg/detail/element_characteristics_stamped__rosidl_typesupport_fastrtps_c.h"
...
#include "avoa/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_avoa
...
using _ElementCharacteristicsStamped__ros_msg_type = avoa__msg__ElementCharacteristicsStamped;
  ...
  void * untyped_ros_message)
{
  ...
  _ElementCharacteristicsStamped__ros_msg_type * ros_message = static_cast<_ElementCharacteristicsStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_avoa
size_t get_serialized_size_avoa__msg__ElementCharacteristicsStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ElementCharacteristicsStamped__ros_msg_type * ros_message = static_cast<const _ElementCharacteristicsStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ElementCharacteristicsStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_avoa__msg__ElementCharacteristicsStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_avoa
size_t max_serialized_size_avoa__msg__ElementCharacteristicsStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = avoa__msg__ElementCharacteristicsStamped;
    is_plain =
      (
...
static size_t _ElementCharacteristicsStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_avoa__msg__ElementCharacteristicsStamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avoa, msg, ElementCharacteristicsStamped)() {
