...
static const _ElementCharacteristicsArray_type_support_symbol_names_t _ElementCharacteristicsArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rvo2_ros2, msg, ElementCharacteristicsArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rvo2_ros2, msg, ElementCharacteristicsArray)),
  }
};
...
{
  return &::rvo2_ros2::msg::rosidl_typesupport_cpp::ElementCharacteristicsArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rvo2_ros2, msg, ElementCharacteristicsArray)() {
  return get_message_type_support_handle<rvo2_ros2::msg::ElementCharacteristicsArray>();
}
