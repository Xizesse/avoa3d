...
static const _ElementCharacteristicsArray_type_support_symbol_names_t _ElementCharacteristicsArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rvo2_ros2, msg, ElementCharacteristicsArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rvo2_ros2, msg, ElementCharacteristicsArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rvo2_ros2, msg, ElementCharacteristicsArray)() {
  return &::rvo2_ros2::msg::rosidl_typesupport_c::ElementCharacteristicsArray_message_type_support_handle;
}
