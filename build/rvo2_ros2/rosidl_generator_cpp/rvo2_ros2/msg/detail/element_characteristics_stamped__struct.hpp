...
#ifndef RVO2_ROS2__MSG__DETAIL__ELEMENT_CHARACTERISTICS_STAMPED__STRUCT_HPP_
#define RVO2_ROS2__MSG__DETAIL__ELEMENT_CHARACTERISTICS_STAMPED__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rvo2_ros2__msg__ElementCharacteristicsStamped __attribute__((deprecated))
#else
# define DEPRECATED__rvo2_ros2__msg__ElementCharacteristicsStamped __declspec(deprecated)
#endif
...
struct ElementCharacteristicsStamped_
{
  ...
  // pointer types
  using RawPtr =
    rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator> *;
  using ConstRawPtr =
    const rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rvo2_ros2__msg__ElementCharacteristicsStamped
    std::shared_ptr<rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rvo2_ros2__msg__ElementCharacteristicsStamped
    std::shared_ptr<rvo2_ros2::msg::ElementCharacteristicsStamped_<ContainerAllocator> const>
...
using ElementCharacteristicsStamped =
  rvo2_ros2::msg::ElementCharacteristicsStamped_<std::allocator<void>>;
...
#endif  // RVO2_ROS2__MSG__DETAIL__ELEMENT_CHARACTERISTICS_STAMPED__STRUCT_HPP_
