...
#include "rvo2_ros2/msg/detail/element_characteristics_array__rosidl_typesupport_fastrtps_c.h"
...
#include "rvo2_ros2/msg/detail/element_characteristics_stamped__functions.h"  // elements
...
using _ElementCharacteristicsArray__ros_msg_type = rvo2_ros2__msg__ElementCharacteristicsArray;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rvo2_ros2
bool cdr_serialize_rvo2_ros2__msg__ElementCharacteristicsArray(
  const rvo2_ros2__msg__ElementCharacteristicsArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: elements
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rvo2_ros2__msg__ElementCharacteristicsStamped(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rvo2_ros2
bool cdr_deserialize_rvo2_ros2__msg__ElementCharacteristicsArray(
  eprosima::fastcdr::Cdr & cdr,
  rvo2_ros2__msg__ElementCharacteristicsArray * ros_message)
{
  // Field name: elements
  {
    uint32_t cdrSize;
    ...
    if (ros_message->elements.data) {
      rvo2_ros2__msg__ElementCharacteristicsStamped__Sequence__fini(&ros_message->elements);
    }
    if (!rvo2_ros2__msg__ElementCharacteristicsStamped__Sequence__init(&ros_message->elements, size)) {
      fprintf(stderr, "failed to create array for field 'elements'");
      return false;
    }
    auto array_ptr = ros_message->elements.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rvo2_ros2__msg__ElementCharacteristicsStamped(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rvo2_ros2
size_t get_serialized_size_rvo2_ros2__msg__ElementCharacteristicsArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: elements
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rvo2_ros2__msg__ElementCharacteristicsStamped(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rvo2_ros2
size_t max_serialized_size_rvo2_ros2__msg__ElementCharacteristicsArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: elements
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rvo2_ros2__msg__ElementCharacteristicsStamped(
  ...
  if (is_plain) {
    ...
    using DataType = rvo2_ros2__msg__ElementCharacteristicsArray;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rvo2_ros2
bool cdr_serialize_key_rvo2_ros2__msg__ElementCharacteristicsArray(
  const rvo2_ros2__msg__ElementCharacteristicsArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: elements
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rvo2_ros2__msg__ElementCharacteristicsStamped(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rvo2_ros2
size_t get_serialized_size_key_rvo2_ros2__msg__ElementCharacteristicsArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ElementCharacteristicsArray__ros_msg_type * ros_message = static_cast<const _ElementCharacteristicsArray__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: elements
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rvo2_ros2__msg__ElementCharacteristicsStamped(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rvo2_ros2
size_t max_serialized_size_key_rvo2_ros2__msg__ElementCharacteristicsArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: elements
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rvo2_ros2__msg__ElementCharacteristicsStamped(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rvo2_ros2__msg__ElementCharacteristicsArray * ros_message = static_cast<const rvo2_ros2__msg__ElementCharacteristicsArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rvo2_ros2__msg__ElementCharacteristicsArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rvo2_ros2__msg__ElementCharacteristicsArray * ros_message = static_cast<rvo2_ros2__msg__ElementCharacteristicsArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rvo2_ros2__msg__ElementCharacteristicsArray(cdr, ros_message);
}

static uint32_t _ElementCharacteristicsArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rvo2_ros2__msg__ElementCharacteristicsArray(
...
static size_t _ElementCharacteristicsArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rvo2_ros2__msg__ElementCharacteristicsArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rvo2_ros2, msg, ElementCharacteristicsArray)() {
