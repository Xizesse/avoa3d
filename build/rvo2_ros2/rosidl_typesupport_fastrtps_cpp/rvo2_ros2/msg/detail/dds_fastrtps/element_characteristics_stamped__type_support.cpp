...
#include "rvo2_ros2/msg/detail/element_characteristics_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rvo2_ros2::msg::ElementCharacteristicsStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rvo2_ros2::msg::ElementCharacteristicsStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rvo2_ros2::msg::ElementCharacteristicsStamped *>(
    untyped_ros_message);
...
{
  return &rvo2_ros2::msg::typesupport_fastrtps_cpp::_ElementCharacteristicsStamped__handle;
}
