...
static const _ElementCharacteristicsArray_type_support_symbol_names_t _ElementCharacteristicsArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avoa3d, msg, ElementCharacteristicsArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, avoa3d, msg, ElementCharacteristicsArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, avoa3d, msg, ElementCharacteristicsArray)() {
  return &::avoa3d::msg::rosidl_typesupport_c::ElementCharacteristicsArray_message_type_support_handle;
}
